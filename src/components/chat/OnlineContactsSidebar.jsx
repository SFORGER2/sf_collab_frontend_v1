  ...
  return (
    <>
      ...
      <div className={[
        ...
        {/* List */}
        <div className="flex-1 overflow-y-auto min-h-0 custom-chat-scrollbar" style={{ WebkitOverflowScrolling: 'touch' }}>
          {isLoading ? (
...
const MemoizedOnlineContactsSidebar = React.memo(OnlineContactsSidebar, (prevProps, nextProps) => {
  return (
...
export default MemoizedOnlineContactsSidebar;