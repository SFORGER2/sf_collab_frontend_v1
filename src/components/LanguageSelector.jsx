...
export default function LanguageSelector() {
  ...
  // Keep html lang/dir in sync whenever i18n.language changes
  useEffect(() => {
  ...
  return (
    <div ref={selectorRef} className="relative inline-block text-left z-[9999] notranslate" translate="no">
      <button
        type="button"
      ...
      >
        ...
        {isTranslating && (
          <span className="ml-1 inline-flex items-center gap-1 text-[10px] text-purple-300">
      ...
      {isOpen && (
        <div
          ...
          className="absolute right-0 mt-2 w-52 overflow-hidden rounded-2xl border border-white/10 bg-slate-950/95 shadow-2xl backdrop-blur z-[10000]"
        >
          {languages.map((lang) => (
            <button
              key={lang.code}
