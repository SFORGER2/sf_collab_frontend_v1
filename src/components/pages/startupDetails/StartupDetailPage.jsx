    ...
    <div className="min-h-screen">
      ...
      {!isAdmin && (
        <SendJoinRequestModal
          isOpen={isSendJoinRequestModalOpen || isApplicationModalOpen}
          onClose={() => {
            if (typeof setIsSendJoinRequestModalOpen === 'function') setIsSendJoinRequestModalOpen(false);
            if (typeof setIsApplicationModalOpen === 'function') setIsApplicationModalOpen(false);
          }}
