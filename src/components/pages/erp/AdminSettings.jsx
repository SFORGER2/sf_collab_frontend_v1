  ...
  return (
    <div className="min-h-screen bg-black text-white p-6 pb-20">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* General Tab – simplified to only show workspace name and slug */}
        {activeTab === "general" && (
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-[#1a1a1a] border border-[#262626] rounded-lg py-3 px-4 text-sm focus:outline-none focus:border-blue-500/50 transition-colors"
                />
                <p className="text-xs text-gray-500">URL‑friendly identifier. Used in API routes.</p>
              </div>
              <div className="pt-6 border-t border-[#262626] flex gap-4">
                <button onClick={handleSaveWorkspace} disabled={saveLoading} className="flex-1 bg-white text-black py-3 rounded-lg font-bold hover:bg-gray-200 disabled:opacity-50 transition-colors">
                  {saveLoading ? "Saving..." : "Save Changes"}
                </button>
                <button onClick={loadWorkspaceDetails} className="flex-1 bg-[#1a1a1a] border border-[#262626] text-white py-3 rounded-lg font-bold hover:bg-[#262626] transition-colors">
                  Discard
                </button>
              </div>
            </div>
