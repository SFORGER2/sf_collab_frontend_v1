...
export default function AIMatchmakingPage() {
  ...
  const fetchRecommendations = useCallback(async () => {
    ...
    setError(null);
    try {
      const data = await matchmakingAPI.getForMe();
      setMatchData(data);
    } catch (err) {
    ...
    <div className="min-h-screen w-full px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="Our AI engine couldn't find any matches for your profile right now. Complete your profile to improve your results."
