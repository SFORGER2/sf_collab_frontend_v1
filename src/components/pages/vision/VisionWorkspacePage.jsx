          ...
          {WORKSPACE_TABS.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-3.5 py-2 min-h-[40px] rounded-xl text-[0.84rem] font-medium whitespace-nowrap transition-all duration-200 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-400 ${
                  isActive
                    ...
                    {Object.entries(VISION_STATE_LABELS).map(([value, cfg]) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-3.5 py-2 min-h-[40px] rounded-xl border text-[0.82rem] font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer ${
                            isActive
                              ? cfg.color
