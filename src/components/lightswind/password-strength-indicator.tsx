...
import type { InputProps } from "./input"; // type-only: InputProps is an interface, not a runtime export
    ...
    <div className={cn("space-y-2", className)}>
      ...
      <div className="relative">
        <Input
          ...
          className={`border bg-transparent flex items-center text-white placeholder:text-gray-500 focus:border-gray-600 focus:ring-gray-600 w-full rounded px-3 py-2 pl-10 pr-10`}
